...
"%NSIS_PATH%" /DINFO_PRODUCTVERSION="2.6.4.2356" /DARG_WAILS_AMD64_BINARY="%BIN_DIR%\%APP_NAME%_amd64.exe" /DARG_WAILS_ARM64_BINARY="%BIN_DIR%\%APP_NAME%_arm64.exe" "%~dp0build\windows\installer\multiarch.nsi"
